...
if($op2=='')
{
$despache=mysql_query("SELECT * FROM ventas order by fecha desc");
}
else {

	 $desde=$_POST['y'].'-'.$_POST['m'].'-'.$_POST['d'];
	 $hasta=$_POST['y1'].'-'.$_POST['m1'].'-'.$_POST['d1'];
	$despache=mysql_query("SELECT * FROM ventas where fecha between '$desde' and '$hasta'   order by fecha desc");
}
...
?>
				<tr>
					...
					<td><?php echo $general['total'];  $total=$total+$general['total'];?> </td>
  ...
  <?php } ?>  
  <tr><td colspan="3"></td><td><?php print $total;?></td>
              </table>
				<!--  end product-table................................... --> 
