...
$hasta=$_GET['hasta'];
$desde=$_GET['desde'];
$cadena="images/".$_GET['cadena'].".jpeg";
$despache=mysql_query("SELECT * FROM compra where   fecha between '$desde' and '$hasta' ");
while($datos=mysql_fetch_array($despache)){ 
 
if(substr($datos[fecha],5,2)=='01')
{
$mes01=$mes01+$datos[total];
}
if(substr($datos[fecha],5,2)=='02')
{
$mes02=$mes02+$datos[total];
}
if(substr($datos[fecha],5,2)=='03')
{
$mes03=$mes03+$datos[total];
}
if(substr($datos[fecha],5,2)=='04')
{
$mes04=$mes04+$datos[total];
}
if(substr($datos[fecha],5,2)=='05')
{
$mes05=$mes05+$datos[total];
}
if(substr($datos[fecha],5,2)=='06')
{
$mes06=$mes06+$datos[total];
}
if(substr($datos[fecha],5,2)=='07')
{
$mes07=$mes07+$datos[total];
}
if(substr($datos[fecha],5,2)=='08')
{
$mes09=$mes09+$datos[total];
}
if(substr($datos[fecha],5,2)=='09')
{
$mes09=$mes09+$datos[total];
}
if(substr($datos[fecha],5,2)=='10')
{
$mes10=$mes10+$datos[total];
}
if(substr($datos[fecha],5,2)=='11')
{
$mes11=$mes11+$datos[total];
}

if(substr($datos[fecha],5,2)=='12')
{
...
$title=utf8_decode("REPORTE DE COMPRAS DE LA FECHA ".$desde." - ".$hasta);
