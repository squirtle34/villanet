...
$despache=mysql_query("SELECT * FROM ventas where cliente='$cliente' and status='$op' order by fecha desc");
}
else {
	...
	$op=$_GET['op'];
	$despache=mysql_query("SELECT * FROM ventas where cliente='$cliente' and status='$op' and fecha between '$desde' and '$hasta' order by fecha desc");
