<?php
include"header.php";
require ("administrador/conexion/aut_config.inc.php");
?>
</div>
...
if($a) { ?>
	<div id="message-green">
				...
				<tr>
					<td class="green-left">Datos Guardados correctamente en el sistema. Para ir al area de ingreso presione <a href="login.php">Aqui</a> </td>
	...
	?>
	 ...
	 <form action="" method="post">
		...
		<tr>
			...
			<td><input class="inp-form" type="text" name="tlf" required></td>
			<td>
