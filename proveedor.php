...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark"><a href=""><h1>Formulario de Registro de Provedores</h1></a></div>
		...
		<tbody><tr>
			...
			<td><input class="inp-form" type="text"></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Razon Social:</th>
			<td><input class="inp-form-error" type="text"></td>
			<td>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<input value="Enviar" class="form-submit" type="button">
		...
		<div id="related-act-bottom">
			...
			<div id="related-act-inner">
				...
				<div class="right">
					...
					Zona de acceso para registro de provedores para la compra de insumos	
